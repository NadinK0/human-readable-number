module.exports = function toReadable (number) {
  ...
  let newArr = Array.from(String(number), Number);
    ...
    if (l < 3 && number < 20 ) 
    {
      ...
      {
        newArr[newArr.length-1] === 0 ? m20_90[newArr[0]-2] : `${m20_90[newArr[0]-2]} ${m1_10[newArr[newArr.length-1]]}`;
      } else if (l < 4) 
        {
          newArr[newArr.length-1] === 0 ? 
    
            newArr[newArr.length-2] === 0 ? 
            `${m1_10[newArr[0]]} ${m100[0]}` : 
            `${m1_10[newArr[0]]} ${m100[0]} ${m20_90[newArr[0]-2]}` : 
    
            newArr[newArr.length-2] === 0? 
            `${m1_10[newArr[0]]} ${m100[0]} ${m1_10[newArr[newArr.length-1]]}`:
            `${m1_10[newArr[0]]} ${m100[0]} ${m20_90[newArr[0]-2]} ${m1_10[newArr[newArr.length-1]]}`;
        }
}
